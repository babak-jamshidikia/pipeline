...
funcGOGroupGene <-function(ont,TopN,P_valcutoff,updown){
  ...
  for (i in 1:nrow(allResUp) ){
    ...
    colnames(RPKMHeat) <-c("Atria_1","Atria_2","Atria_3","Vent_1","Vent_2","Vent_3") 
  ...
  #saving excel file 
  saveWorkbook(wbxl, paste0("~/Desktop/BIOINFORMATICS_jacobi/graphs/HeatMaps/",ont , "/",updown ,"/genes_per_GO_ID.xlsx"), overwrite = TRUE)
